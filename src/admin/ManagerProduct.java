...
public class ManagerProduct extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ManagerProduct frame = new ManagerProduct();
...
int xx,xy;
	...
	public ManagerProduct() {
		...
		btnNewButton.setBounds(143, 392, 89, 23);
		panel.add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("Delete");
		btnNewButton_1.setBackground(new Color(0, 102, 204));
		btnNewButton_1.setFont(new Font("Times New Roman", Font.BOLD, 14));
		btnNewButton_1.setBounds(10, 449, 89, 23);
		...
		btnNewButton_1_1.setBounds(143, 449, 89, 23);
		panel.add(btnNewButton_1_1);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(320, 63, 440, 409);
